package com.sht.smartlock.recordbylame;
...
public class AudioRecorder2Mp3Util {
	 ...
	 * 文件路径
	 */
	private String rawPath = android.os.Environment.getExternalStorageDirectory() + "/test.amr";
	private String mp3Path = android.os.Environment.getExternalStorageDirectory() + "/test.mp3";
