...
package com.sht.smartlock.ui.chat.applib.video.util;
...
import com.sht.smartlock.BuildConfig;


/**
 * This class memory caching of bitmaps in conjunction with the
 * {@link ImageWorker} class and its subclasses. Use
 * {@link ImageCache01#getInstance(FragmentManager, ImageCacheParams)}
...
public class ImageCache01 {
	 ...
	 */
	private ImageCache01(ImageCacheParams cacheParams) {
		init(cacheParams);
	}

	/**
	 * Return an {@link ImageCache01} instance. A {@link RetainFragment} is used
	 ...
	 *         not exist
	 */
	public static ImageCache01 getInstance(FragmentManager fragmentManager,
		...
		ImageCache01 imageCache = (ImageCache01) mRetainFragment.getObject();

		// No existing ImageCache, create one and store it in RetainFragment
		if (imageCache == null) {
			imageCache = new ImageCache01(cacheParams);
