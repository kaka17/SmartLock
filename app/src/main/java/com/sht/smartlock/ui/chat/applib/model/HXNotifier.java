 ...
 */
package com.sht.smartlock.ui.chat.applib.model;
...
public class HXNotifier {
    ...
    protected void sendNotification(EMMessage message, boolean isForeground, boolean numIncrease) {
        ...
        int num= getUnreadMsgCountTotal();
        if (num>0){
//            list.get(1).setUnreadMsgCount(num);
            boolean b = ShortcutBadger.applyCount(appContext, num);
        }else {
