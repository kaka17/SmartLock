...
public class ChatAllHistoryAdapter extends ArrayAdapter<EMConversation> {
    ...
    public ChatAllHistoryAdapter(Context context, int textViewResourceId, List<EMConversation> objects, List<User> myUsers) {
    ...
    public void getList(List<EMConversation> list) {
...
//		AppContext.toast("ada"+conversationList.size());
...
//			holder.avatar.setImageResource(R.drawable.group_icon);
            holder.avatar.setImageResource(R.drawable.chat_room_head);
...
//		    holder.avatar.setImageResource(R.drawable.group_icon);
            ...
            if (username == null || username.equals("null")) {
                ...
                if (robotMap != null && robotMap.containsKey(username)) {
                    ...
                    boolean contains = myUsers.contains(username);
                    AppContext.toast(contains + "1");
                    ...
                    if (myUsers.size() > 0) {
                        for (int i = 0; i < myUsers.size(); i++) {
                            String emid = myUsers.get(i).getEmid();
                            if (username.equals(emid)) {//
                                holder.name.setText(myUsers.get(i).getNick());//
                                ImageLoader.getInstance().displayImage(myUsers.get(i).getId_image(), holder.avatar);
//							UserUtils.getUserInfo(username).setAvatar(myUsers.get(i).getId_image());
//							UserUtils.setUserAvatar(getContext(), username, holder.avatar);
                            }
                        }
                    }
