...
import com.sht.smartlock.widget.indicator.PtrIndicator;
import com.sht.smartlock.widget.util.PtrCLog;


/**
 * This layout view for "Pull to Refresh(Ptr)" support all of the view, you can contain everything you want.
 * support: pull to refreshData / release to refreshData / auto refreshData / keep header view while refreshing / hide header view while refreshing
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private void updatePos(int change) {
        ...
        // leave initiated position or just refreshData complete
        ...
        if (mStatus == PTR_STATUS_PREPARE) {
            ...
            // reach header height while auto refreshData
    ...
    /**
     * Do refreshData complete work when time elapsed is greater than {@link #mLoadingMinTime}
     */
    private void performRefreshComplete() {
        mStatus = PTR_STATUS_COMPLETE;

        // if is auto refreshData do nothing, wait scroller stop
        if (mScrollChecker.mIsRunning && isAutoRefresh()) {
            // do nothing
            if (DEBUG) {
                PtrCLog.d(LOG_TAG, "performRefreshComplete do nothing, scrolling: %s, auto refreshData: %s",
    ...
    /**
     * Do real refreshData work. If there is a hook, execute the hook first.
     *
     * @param ignoreHook
     */
