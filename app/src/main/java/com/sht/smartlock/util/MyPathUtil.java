...
public class MyPathUtil {
    ...
    private static MyPathUtil instance = null;
    ...
    public static MyPathUtil getInstance() {
        if(instance == null) {
            instance = new MyPathUtil();
        }
    ...
    public void initDirs(String var1, String var2, Context var3) {
        ...
        this.apkPath = generateApkPath(var1, var2, var3);
    ...
    private static File generateApkPath(String var0, String var1, Context var2) {
        String var3 = null;
        if(var0 == null) {
            var3 = pathPrefix + var1 + "/apk/";
        } else {
            var3 = pathPrefix + var0 + "/" + var1 + "/apk/";
        }
